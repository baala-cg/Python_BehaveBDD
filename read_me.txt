...
My system:
--virtualenv --python="C:\Users\admin\AppData\Local\Programs\Python\Python311\python.exe" venv1
...
Install all the requirments from the requirements.txt
...
In PyCharm:
File-> Settings - > Project -> Project Interpreter -> Settings -> Add -> Existing environment -> Browse -> select python.exe
from virtual env - venv1
